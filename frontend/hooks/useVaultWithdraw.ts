...
/**
 * Custom hook for withdrawing tokens from vaults
 */
export function useVaultWithdraw() {
  ...
  const withdraw = async ({
    ...
    try {
      ...
      console.log("VAULT WITHDRAWAL FLOW (CUSTODIAL)");
      console.log("=".repeat(50));
      ...
      console.log("Step 2: Requesting vault withdrawal...");
